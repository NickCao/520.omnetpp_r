...
class SIM_API SimTime
{
  ...
  public:
    ...
    static const int SCALEEXP_S;
    static const int SCALEEXP_MS;
    static const int SCALEEXP_US;
    static const int SCALEEXP_NS;
    static const int SCALEEXP_PS;
    static const int SCALEEXP_FS;
