...
#define ETHERNET_TXRATE              10000000    /* 10 Mbit/sec (in bit/s) */
#define FAST_ETHERNET_TXRATE         100000000   /* 100 Mbit/sec (in bit/s) */
#define GIGABIT_ETHERNET_TXRATE      1000000000  /* 1 Gbit/sec (in bit/s) */
#define FAST_GIGABIT_ETHERNET_TXRATE 10000000000 /* 10 Gbit/sec (in bit/s) */
#define SLOT_TIME                    (SimTime(512, -7))  /* 512/ETHERNET_TXRATE for Ethernet & Fast Ethernet, in seconds */
#define GIGABIT_SLOT_TIME            (SimTime(4096, -9)) /* 4096/GIGABIT_ETHERNET_TXRATE seconds */
