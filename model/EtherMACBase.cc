...
static const long SPEED_OF_LIGHT = 200000000;
...
void EtherMACBase::calculateParameters()
{
    ...
    interFrameGap = SimTime(INTERFRAME_GAP_BITS)/txrate;
...
void EtherMACBase::finish()
{
    if (!disabled)
    {
        ...
        recordScalar("txrate (Mb)", txrate/1000000.0);
